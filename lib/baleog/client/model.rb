...
module Baleog
  class Client
    ...
    class Model
      autoload :Builder,      'baleog/client/model/builder'
      autoload :ClassMethods, 'baleog/client/model/class_methods'
      autoload :FieldBuilder, 'baleog/client/model/field_builder'
      autoload :FieldOptions, 'baleog/client/model/field_options'
