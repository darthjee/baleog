...
module Baleog
  class Client
    class Model
      ...
      #
      # @see Baleog::Client::Model.field Baleog::Client::Model.field
      class FieldOptions < Sinclair::Options
        ...
        # @api private
        #
        # Caster class used when casting a value from the field return
        #
        # @see Baleog::Client::Model::ValueWrapper
        # @return Baleog::Client::Model::ValueWrapper
